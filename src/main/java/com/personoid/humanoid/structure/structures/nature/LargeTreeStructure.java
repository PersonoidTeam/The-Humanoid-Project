...
public class LargeTreeStructure extends StructureRef {
    ...
    private void initialiseLayers() {
        ...
        logLayer = new Layer(Collections.singletonList(logMaterial), Bounds.of(1, 4), Bounds.of(6, 18), true);
        ...
        leavesLayer = new Layer(Collections.singletonList(leavesMaterial), Bounds.of(4), Bounds.of(8, 12), true);
    }
